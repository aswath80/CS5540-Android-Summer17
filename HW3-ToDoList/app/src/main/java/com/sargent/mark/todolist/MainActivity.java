...
public class MainActivity extends AppCompatActivity
   ...
   @Override protected void onStart() {
      ...
      adapter = new ToDoListAdapter(cursor,
            new ToDoListAdapter.ItemClickListener() {
               ...
               @Override public void onItemClick(int pos, String description,
                     String duedate, String category, long id) {
                  Log.d(TAG, "item click id: " + id);
                  String[] dateInfo = duedate.split("-");
                  int year = Integer.parseInt(
                        dateInfo[0].replaceAll("\\s", ""));
                  int month = Integer.parseInt(
                        dateInfo[1].replaceAll("\\s", ""));
            ...
            //[Mani]TODO: Implementation of custom ItemLongClickListener
            // to update the database with done status
            new ToDoListAdapter.ItemLongClickListener() {
               @Override
      ...
      new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
         ...
         @Override public void onSwiped(RecyclerView.ViewHolder viewHolder,
               int swipeDir) {
   ...
   private Cursor getAllItems(SQLiteDatabase db) {
      return db.query(Contract.TABLE_TODO.TABLE_NAME, null, null, null, null,
            null, Contract.TABLE_TODO.COLUMN_NAME_DUE_DATE);
   }
   ...
   private long addToDo(SQLiteDatabase db, String description, String duedate,
      ...
      //[Mani]TODO:Category information added to database insert
   ...
   private boolean removeToDo(SQLiteDatabase db, long id) {
      ...
      return db.delete(Contract.TABLE_TODO.TABLE_NAME,
            Contract.TABLE_TODO._ID + "=" + id, null) > 0;
   }

   private int updateToDo(SQLiteDatabase db, int year, int month, int day,
      ...
      cv.put(Contract.TABLE_TODO.COLUMN_NAME_DESCRIPTION, description);
      cv.put(Contract.TABLE_TODO.COLUMN_NAME_DUE_DATE, duedate);
      //[Mani]TODO:Category information added to database update
      cv.put(Contract.TABLE_TODO.COLUMN_NAME_CATEGORY, category);
      return db.update(Contract.TABLE_TODO.TABLE_NAME, cv,
            Contract.TABLE_TODO._ID + "=" + id, null);
   }

   @Override public void closeUpdateDialog(int year, int month, int day,
         String description, String category, long id) {
